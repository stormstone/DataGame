...
to_drop = ["uid", "active_date", "loan_sum", "pay_end_date", 'cate_id_cnt_cate_id_24', 'cate_id_cnt_cate_id_8',
           'cate_id_sum_cate_id_24', 'cate_id_sum_cate_id_8', 'isloan_pred', 'clickLoanBehaviorCode_y',
           u'pid_param_pos1', u'pid_param_pos2', u'pid_param_pos3', u'pid_param_pos4', u'pid_param_pos5']
...
param = {'num_leaves': 8, 'num_boost_round': 500, 'objective': 'regression_l2', 'metric': 'rmse', "learning_rate": 0.05,
         "boosting": "gbdt", "lambda_l2": 1500, "feature_fraction": 0.9, "bagging_fraction": 0.9, "bagging_freq": 50,
         "top_rate": 0.01}
...
lgb_sub[["uid", "lgb_loan_sum"]].to_csv("./submission/" + now_time + '_lightgbm_Vscore_' + str(valid_score) + '.csv',
...
print('saving submission...')
now_time = time.strftime("%m-%d %H_%M_%S", time.localtime())
catb_sub[["uid", "catb_loan_sum"]].to_csv("./submission/" + now_time + '_lightgbm_Vscore_' + str(valid_score) + '.csv',
                                          index=False, header=False)
